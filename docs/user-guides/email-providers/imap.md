...
3.  **Create the Password:**
    ...
    - Give it a name you'll recognize, like "ProofArchiveSender".
    - Click **"Generate"**.
4.  **Use the Password:** A 16-digit password will be displayed. Copy this password and paste it into the **Password** field in the ProofArchiveSender ingestion source form.
...
4.  **Use the Password:** A new password will be generated. Use this password in the **Password** field in the ProofArchiveSender ingestion source form.

import { IStorageProvider, StorageConfig } from '@ProofArchive/types';
...
/**
 *  A unique identifier for ProofArchive encrypted files. This value SHOULD NOT BE ALTERED in future development to ensure compatibility.
 */

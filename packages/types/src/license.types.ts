/**
 * Features of ProofArchive Enterprise
 */
export enum ProofArchiveFeature {
	AUDIT_LOG = 'audit-log',
...
export interface LicensePingRequest {
	...
	activeSeats: number;
	/** Version string of the running ProofArchive instance. */
	version: string;
}
...
export interface ConsolidatedLicenseStatus {
	...
	isExpired: boolean;
	features: {
		[key in ProofArchiveFeature]?: boolean;
	};
}
